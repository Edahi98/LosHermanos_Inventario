...
@section('content')
    <div class="container mx-auto px-4 py-8">
        <div class="flex items-center justify-between mb-6">
            <h1 class="text-3xl font-bold text-gray-800">Agregar Nueva Categoría</h1>
        ...
        <div class="bg-white shadow-2xl rounded-lg p-6">
            <form action="{{ route('categorias.store') }}" method="POST">
                ...
                <div class="mb-6">
                    ...
                    <input type="text" name="nombre_categoria" id="nombre_categoria" class="shadow-sm appearance-none border rounded-lg w-full py-3 px-4 text-gray-700 leading-tight focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent" placeholder="Ingrese el nombre de la categoría">
                </div>
